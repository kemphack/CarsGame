...
class Car(
        ...
        private var rotationAcceleration: Float = 0.0f,
    ...
    fun turn(delta: Float, userForce: Float, userRotation: Float) {
        ...
        rotationAcceleration = userRotation
        rotationSpeed = if(speed.isZero) 0f else delta * rotationAcceleration
        collider.angle += delta * rotationSpeed
    }
}
